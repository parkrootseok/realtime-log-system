...
- [x] **React 프로젝트 생성**
- [x] **패키지 설치**: `@mui/material`, `styled-components`, `recharts`, `axios` 등
- [x] **프로젝트 구조 설정**: `components`, `services`, `styles` 등
- [x] **스타일링 설정**: `GlobalStyle`, `theme`
- [x] **API 기본 구조 구축**
- [x] **Prettier, ESlint, 환경 변수 (.env), .gitignore 설정**
